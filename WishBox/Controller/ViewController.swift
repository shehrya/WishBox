...
//        generateTestData()
    ...
    func generateTestData() {
        ...
        item.price = 82000
        item.details = "Oh man this is a beautiful car. And one day, I willl own it"
        
        let item2 = Item(context: context)
        item2.title = "Tesla Roadster"
        item2.price = 120000
        item2.details = "Its Beast"
        
        let item3 = Item(context: context)
        item3.title = "iPhone X"
        item3.price = 1149
        item3.details = "I can't wait until the event, I hope they release."
